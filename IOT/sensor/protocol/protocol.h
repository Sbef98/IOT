...
///////////////// SOME FUNCTIONS DEF /////////
typedef unsigned char (*data_collector) (char* data_buffer);
typedef unsigned char (*data_eater) (char* data_buffer);
...
#define new_device(x_func, y_func) {x_func, y_func, not_initialized}
